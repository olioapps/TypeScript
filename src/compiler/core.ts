...
namespace ts {
    ...
    /**
     * Describes a semantic version number, per https://semver.org
     */
    export class Version {
        static readonly zero = new Version(0, 0);
        ...
        compareTo(other: Version) {
            ...
            return compareValues(this.major, other.major)
                ...
                || compareVersionFragments(this.prerelease, other.prerelease);
        }
    }

    function compareVersionFragments(left: ReadonlyArray<string>, right: ReadonlyArray<string>) {
        // Per https://semver.org/#spec-item-11:
        //
